    ...
    <div className="App">
      <div>
        <Navbar bg="light" variant="light">
          <Container style={{backgroundColor: "#27dae2", padding: "0px 20px"}}>
            <Navbar.Brand href={RouteConst.MAIN_PAGE}>Portfolio</Navbar.Brand>
            <Nav className="me-auto">
              {logInfo ? <Link to={RouteConst.ADMIN_PAGE}>Admin</Link> : <Link to={RouteConst.LOGIN_FORM}>Login</Link>}
            </Nav>
            {logInfo ? <Button style={{backgroundColor: "#27dae2"}} variant="danger" onClick={logOutClickHandler}>Log out</Button> : <></>}
          </Container>
        </Navbar>
